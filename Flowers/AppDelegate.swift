...
//  Flowers
//
//  Created by Jacques Micheli on 04/09/2020.
...
/*
 * All references to window object commented out wit 'TMP'
 * Oct 25 2020 17h57
 */
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // TMP var window: UIWindow?

    func application(_ application: UIApplication, willFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil) -> Bool
    {
        // Override point for customization after application launch.
        print("AppeDelegate 1")
        // TMP window = UIWindow(frame: UIScreen.main.bounds)
        
        // To create from a Storyboard
        // TMP window?.rootViewController = UIStoryboard(name: "Main", bundle: nil).instantiateInitialViewController()!
        
        // TMP print("window \(String(describing: window)), window?.rootViewController \(String(describing: window?.rootViewController))")
        ...
        // TMP window?.rootViewController = pulleyDrawerVC
         */
        
        // TMP window?.makeKeyAndVisible()
